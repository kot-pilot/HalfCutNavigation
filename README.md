Half cut navigation is the additional way to navigate through file text with key shortcuts. Most users utilize 'home' (move caret to line start), 'end' (move caret to line end),
